...
public class PreferitiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewAdapter = new ListViewAdapter(PreferitiActivity.this, listaItemModels);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(PreferitiActivity.this, "hai clickato: " + itemModel.getTitolo(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}